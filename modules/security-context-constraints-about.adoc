...
The cluster contains eight default security context constraints (SCCs) as described in the table below. By default, all pods and containers use the `restricted` SCC.
