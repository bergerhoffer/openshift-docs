...
You can replace an etcd member that has failed or is stopped.

.Prerequisites

* You have identified the unhealthy etcd member.
* You have verified that the node is not running.
...
// TODO: Update to add terminal w/ access sentences
...
+
----
$ oc delete machine ci-ln-mpprd6t-d5d6b-n94jk-master-0 -n openshift-machine-api
----
+
// TODO: This command takes a few minutes to come back, just wait it out?
...
// TODO: Need to add a final verification step. The process seems to take quite a few minutes.
